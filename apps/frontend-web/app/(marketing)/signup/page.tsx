    ...
    <div className="min-h-screen bg-[#f8fafd] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#4a6890] mt-2">Create your account</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-[#c8ddf5] p-8 shadow-lg">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#4a6890]" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              ...
              <p className="text-xs text-[#4a6890] mt-1">Must be at least 8 characters</p>
            </div>
          ...
          <p className="text-center text-sm text-[#4a6890] mt-6">
            ...
            <Link href="/login" className="text-[#007acc] hover:text-[#00509e] font-medium">
              Sign in
            </Link>
          </p>
        </div>
