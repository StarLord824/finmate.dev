...
// CoinGecko ticker (uppercase) → Yahoo Finance symbol for history lookups
// Covers top-50 by market cap as returned by /coins/markets
export const COINGECKO_TO_YAHOO: Record<string, string> = {
  BTC:   "BTC-USD",
  ETH:   "ETH-USD",
  USDT:  "USDT-USD",
  BNB:   "BNB-USD",
